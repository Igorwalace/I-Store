    ...
    return (
        <>
            <main className='font-extralight' >
                <div className='border-t-2 border-[#2A2A2A] p-2 flex items-center justify-between' >
                    <h1>SubTotal</h1>
                    <h1>R$ {priceSubTotal.toFixed(2).replace(".", ",")}</h1>
                </div>
                <div className='border-t-2 border-[#2A2A2A] p-2 flex items-center justify-between' >
                    <h1>Total de Descontos</h1>
                ...
                <div className='border-t-2 border-b-2 border-[#2A2A2A] p-2 flex items-center justify-between font-extrabold' >
                    <h1>Total</h1>
